...
2 - espaço(Apartamento, Armario, Geladeira)
...
public class Apartamento implements espaco{
	public int areaInterna(){
...
public class Armario implements espaco{
	public int areaInterna(){
...
public class Geladeira implements espaco{
	public int areaInterna(){
